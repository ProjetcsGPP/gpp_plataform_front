...
export function ActivityFeed() {
  return (
    <div className="bg-surface-container-lowest rounded-lg shadow-sm h-125 flex flex-col">
        ...
        {activities.map((item, index) => (
          <div key={item.id} className="flex gap-4 relative">
            {index < activities.length - 1 && (
              <div className="absolute left-4 top-8 bottom-4 w-px bg-slate-100" />
            )}
            <div
            ...
            <div>
              ...
              <p className="text-sm font-semibold mt-0.5 text-on-surface">
                {item.title}
              </p>
