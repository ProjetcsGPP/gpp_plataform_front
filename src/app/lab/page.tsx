  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex flex-col flex-1 ml-20 min-h-screen">
        <TopBar titleMinor="Lab" title="Laboratório" appContext="PORTAL" />
        <main className="px-8 py-8 space-y-10 max-w-400 mx-auto w-full">
          {/* === 1. PageHeader === */}
          <PageHeader
            ...
            action={
              <button className="px-6 py-3 bg-linear-to-br from-primary to-primary-container text-on-primary font-semibold rounded-lg shadow-lg hover:brightness-110 active:scale-95 transition-all flex items-center gap-2">
          ...
          {/* === 2. StatCards === */}
          <section>
            <h3 className="text-lg font-bold text-primary mb-6 font-headline">
              Métricas Principais
            </h3>
